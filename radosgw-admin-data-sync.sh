...
$BIN/bin/radosgw-admin --log-to-stderr --format json -n client.1 -k $BIN/ceph.client.radosgw.keyring user create --uid client1-system-user --access-key $SYSTEM_ACCESS_KEY --secret $SYSTEM_SECRET_KEY --display-name client1-system-user --system --rgw-zone=r0z1
$BIN/bin/radosgw-admin --log-to-stderr --format json -n client.0 -k $BIN/ceph.client.radosgw.keyring user create --uid client1-system-user --access-key $SYSTEM_ACCESS_KEY --secret $SYSTEM_SECRET_KEY --display-name client1-system-user --system
$BIN/bin/radosgw-admin --log-to-stderr --format json -n client.1 -k $BIN/ceph.client.radosgw.keyring user create --uid client0-system-user --access-key $SYSTEM_ACCESS_KEY --secret $SYSTEM_SECRET_KEY --display-name client0-system-user --system --rgw-zone=r0z1
$BIN/bin/radosgw-admin --log-to-stderr --format json -n client.0 -k $BIN/ceph.client.radosgw.keyring user create --uid client0-system-user --access-key $SYSTEM_ACCESS_KEY --secret $SYSTEM_SECRET_KEY --display-name client0-system-user --system

$BIN/bin/radosgw-admin --log-to-stderr --format json -n client.0 -k ./ceph.client.radosgw.keyring user create --uid foo --display-name Foo --email foo@foo.com --access-key $SYSTEM_ACCESS_KEY --secret $SYSTEM_SECRET_KEY --max-buckets 4
